...
1. Пользователь создаёт тему и задаёт для неё **тег/метку**. По этому тегу агент ищет релевантные посты. При создании можно (и рекомендуется) добавить **краткое описание** — что именно
   имеется в виду под тегом. Описание помогает слабой модели не отбирать всё подряд; держите его коротким,
